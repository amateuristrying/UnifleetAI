-- =============================================================
-- TAT V2 REFACTOR: Phase 11 — Phase 3 Session Overlap Fix
-- Purpose:
--   Force replace build_trip_state_events_v2() with overlap-safe
--   sessionization so midnight-split rows do not create false trips.
-- Dependency: tat_v2_refactor_phase_3_fix.sql (already applied)
--
-- Changes vs currently deployed phase_3_fix:
...
--   [MIDNIGHT]  session continuity uses previous running MAX(out_time)
--               instead of LAG(out_time) to handle overlapping rows
-- =============================================================
