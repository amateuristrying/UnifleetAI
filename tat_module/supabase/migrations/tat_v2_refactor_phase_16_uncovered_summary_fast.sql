-- =============================================================
-- TAT V2 REFACTOR: Phase 16
-- Feature: Fast uncovered-vs-facts summary for dashboard use.
--
-- Why:
--   The detailed uncovered inspector can be expensive over long windows.
--   This function keeps the same uncovered detection logic, but returns
--   summary-only output (overall + tracker-wise), avoiding heavy detail payloads.
-- =============================================================
