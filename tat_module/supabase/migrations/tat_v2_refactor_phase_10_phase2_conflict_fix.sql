-- =============================================================
-- TAT V2 REFACTOR: Phase 10 — Phase 2 Conflict-Safe Insert
-- Purpose:
--   Force replace refresh_trip_geofence_events_normalized() with
--   canonical-visit dedupe logic compatible with uq_tgen_* indexes.
-- =============================================================
