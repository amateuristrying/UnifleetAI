...
base_path = "src/app/trip/[id]"

# 2. Force create the directory (Python handles [ ] correctly)
try:
    os.makedirs(base_path, exist_ok=True)
    print(f"✅ Successfully created directory: {base_path}")
...
# 4. Write the file
file_path = os.path.join(base_path, "page.tsx")
try:
